    ...
    }
    {
        ...
        destruct (decide (x = a)).
        {
            ...
            assert (H2: vars_of e1 ⊆ vars_of ρ2).
            {
                ...
                unfold vars_of at 1 in H; simpl in H.
                unfold vars_of at 1 in H; simpl in H.
                ...
                unfold vars_of in Hx12'; simpl in Hx12'.
                apply val_elem_of_dom_1 in Hx12'.
                unfold Valuation in *.
                unfold isSome in *.
                destruct (ρ1 !! x)>[|inversion Hx12'].
            ...
            assert (H3: vars_of e2 ⊆ vars_of ρ2).
            {
                ...
                unfold vars_of in Hx11'; simpl in Hx11'.
                apply val_elem_of_dom_1 in Hx11'.
                unfold isSome in Hx11'.
                destruct (ρ1 !! x) eqn:Htmp>[|inversion Hx11'].
                eapply elem_of_dom_2.
                rewrite <- H.
                reflexivity.
            }

            apply Expression_evalute_total_T_2 in H2 as H2'.
            apply Expression_evalute_total_T_2 in H3 as H3'.
            destruct H2' as [g2 H2'].
            destruct H3' as [g3 H3'].
            rewrite H2'. rewrite <- H2'.
            split>[|reflexivity].
            assert (Some g2 = Some x11).
            {
                rewrite <- H11.
                rewrite <- H2'.
                apply Expression_evaluate_val_restrict.
                unfold valuation_restrict.
                rewrite map_filter_strong_ext.
                intros i x. simpl.
                split; intros [HH'1 HH'2].
                {
                    rewrite H.
                    {
                        unfold Valuation in *.
...
Lemma factor_by_subst_correct_2
    ...
    let xy := factor_by_subst sz ρ h γ φ ψ in
    ((satisfies ρ xy.2 ψ) *
    (satisfies (<[h := (uglify' xy.2)]>ρ) xy.1 φ))%type
.
Proof.
    revert γ φ.
    induction sz; intros γ φ Hsz.
    ...
    }
    {
        ...
        destruct (matchesb ρ (uglify' γ) (uglify' ψ)) eqn:Heqmb.
        {
            ...
            split.
            {
                apply matchesb_satisfies in Heqmb.
                unfold satisfies; simpl.
                apply Heqmb.
            }
            {
        ...
        }
        {
            destruct γ.
            {
                ...
                }
                {
                    simpl in *.
                    apply satisfies_term_bov_inv in Hsat.
                    destruct Hsat as [HContra0 [[HContra10 HContra11] HContra2]].
                    inversion HContra10.
                }
            }
            {
                    ...
                    destruct (list_find (λ φi : TermOver BuiltinOrVar, h ∈ vars_of_to_l2r φi) l0) eqn:Hfind.
                    {
                        ...
                        destruct (l !! n) eqn:Hln.
                        {
                            ...
                            ltac1:(ospecialize (IHsz _)).
                            {
                                ...
                                rewrite map_app in H3.
                                rewrite map_cons in H3.
                                eapply H3 with (i := length (take n lγ)).
                                {
                                    rewrite lookup_app_r.
                                    {
                            ...
                            { reflexivity. }
                            {
                                ...
                                rewrite insert_app_r_alt.
                                {
                                    ...
                                    rewrite Nat.min_l.
                                    {
                                        ...
                                        intros i s l.
                                        intros H1i H2i.
                                        destruct (decide (i < length (take n lγ))) as [Hlt|Hge].
                                        {
                                            rewrite lookup_app_l in H1i>[|ltac1:(lia)].
                                            rewrite lookup_app_l in H2i.
                                            {
                                                eapply satisfies_TermOver_vars_of>[|eapply H3].
                                                {
                                                    intros x Hx.
                                                    destruct (decide (h = x)).
                                                    {
                                                        ...
                                                        destruct Hx as [j Hj].
                                                        apply take_drop_middle in Hj.
                                                        rewrite lookup_take in H2i>[|(apply lookup_lt_Some in H2i;rewrite take_length in H2i; ltac1:(lia))].
                                                        apply take_drop_middle in H2i.
                                                        rewrite <- H2i in Hlf.
                                                        rewrite map_app in Hlf. simpl in Hlf.
                                                        rewrite <- Hj in Hlf.
                                                        rewrite take_length in Hlt.
                                                        (* TODO simplify Hlf and then use Hfind1 *)
                                                        rewrite concat_app in Hlf.
                                                        simpl in Hlf.
                                                        rewrite filter_app in Hlf; simpl in Hlf.
                                                        rewrite filter_app in Hlf; simpl in Hlf.
                                                        rewrite filter_app in Hlf; simpl in Hlf.
                                                        rewrite filter_cons in Hlf.
                                                        ...
                                                        {
                                                            rewrite map_app in Hlf; simpl in Hlf.
                                                            rewrite concat_app in Hlf; simpl in Hlf.
                                                            rewrite filter_app in Hlf; simpl in Hlf.
                                                            rewrite elem_of_list_lookup in Hfind2.
                                                            destruct Hfind2 as [j3 Hj3].
                                                            apply take_drop_middle in Hj3.
                                                            rewrite <- Hj3 in Hlf.
                                                            rewrite filter_app in Hlf; simpl in Hlf.
                                                            rewrite filter_app in Hlf; simpl in Hlf.
                                                            rewrite filter_cons in Hlf.
                                                        ...
                                                        {
                                                            rewrite take_length in Htmp1.
                                                            ltac1:(lia).
                                                        }
                                                    }
                                                    {
                                                        unfold Valuation in *.
                                                        rewrite lookup_insert_ne>[reflexivity|ltac1:(congruence)].
                                                    }
                                                }
                                                {
                                                    rewrite lookup_take in H1i.
                                                    {
                                                        apply H1i.
                                                    }
                                                    {
                                        ...
                                        destruct (decide (((length (take n lγ))) < i)) as [Hlt'|Hge'].
                                        {
                                            rewrite lookup_app_r in H1i>[|ltac1:(lia)].
                                            ...
                                            rewrite lookup_app_r in H2i.
                                            {
                                                ...
                                                eapply satisfies_TermOver_vars_of>[|eapply H3].
                                                {
                                                    ...
                                                    destruct (decide (h = x)).
                                                    {
                                                        ...
                                                        rewrite drop_app in Hlf.
                                                        rewrite take_app in Hlf.
                                                        destruct ((S (n + n1) - length (take n l0))) eqn:Htmp3; simpl in *.
                                                        {
                                                            rewrite take_length in Htmp3.
                                                            ltac1:(lia).
                                                        }
                                                        {
                                                            rewrite map_app in Hlf; simpl in Hlf.
                                                ...
                                                }
                                                {
                                                    ...
                                                    { reflexivity. }
                                                    {
                                                        ...
                                                        destruct ((S (n + n0) - n `min` length l0)) eqn:Heq1.
                                                        {
                                                            simpl in Hlf.
                                                            ltac1:(lia).
                                                        }
                                        ...
                                        assert (i = length (take n lγ)).
                                        {
                                            ltac1:(lia).
                                        }
                                        subst i.
                                        rewrite lookup_app_r in H2i.
                                        rewrite lookup_app_r in H1i.
                                        rewrite take_length in H2i.
                                        rewrite take_length in H2i.
                                        rewrite Nat.sub_diag in H1i.
                                        simpl in H1i.
                                        rewrite H2 in H2i.
                                ...
                                }
                                {
                                    destruct i; simpl in *.
                                    {
                                        ...
                                        destruct i; simpl in *.
                                        {
                                            ...
                                            eapply satisfies_TermOverBoV_to_TermOverExpr.
                                            eapply satisfies_TermOverExpression_vars_of.
