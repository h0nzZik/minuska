...
Definition isValue (X : Expression2) := (e_fun b_or [(e_fun b_isZ [(X)]); (e_fun b_or [(e_fun b_isBool [(X)]); (e_fun b_or [(e_fun b_have_same_symbol [(X); (e_ground (@t_term symbol builtin_value "unitValue" []))]); (e_fun b_isString [(X)])])])]).
...
(basic_rule "init" (@t_term symbol BuiltinOrVar "builtin.init" [(t_over (bov_variable "X"))]) (@t_term symbol Expression2 "c" [(@t_term symbol Expression2 "builtin.cseq" [(@t_over symbol Expression2(e_variable "X")); (@t_term symbol Expression2 "builtin.empty_cseq" [])]); (@t_over symbol Expression2(e_fun b_map_empty []))]) (e_fun b_true []))
; (framed_rule frame_simple "aexpr.plus" (@t_term symbol BuiltinOrVar "plus" [(t_over (bov_variable "X")); (t_over (bov_variable "Y"))]) (@t_over symbol Expression2(e_fun b_Z_plus [(e_variable "X"); (e_variable "Y")])) (e_fun b_and [(e_fun b_isZ [(e_variable "X")]); (e_fun b_isZ [(e_variable "Y")])]))
; (framed_rule frame_simple "aexpr.minus" (@t_term symbol BuiltinOrVar "minus" [(t_over (bov_variable "X")); (t_over (bov_variable "Y"))]) (@t_over symbol Expression2(e_fun b_Z_minus [(e_variable "X"); (e_variable "Y")])) (e_fun b_and [(e_fun b_isZ [(e_variable "X")]); (e_fun b_isZ [(e_variable "Y")])]))
; (basic_rule "var.assign" (@t_term symbol BuiltinOrVar "c" [(@t_term symbol BuiltinOrVar "builtin.cseq" [(@t_term symbol BuiltinOrVar "assign" [(t_over (bov_variable "X")); (t_over (bov_variable "V"))]); (t_over (bov_variable "REST"))]); (t_over (bov_variable "STATE"))]) (@t_term symbol Expression2 "c" [(@t_term symbol Expression2 "builtin.cseq" [(@t_term symbol Expression2 "unitValue" []); (@t_over symbol Expression2(e_variable "REST"))]); (@t_over symbol Expression2(e_fun b_map_update [(e_variable "STATE"); (e_variable "X"); (e_variable "V")]))]) (e_fun b_and [(e_fun b_have_same_symbol [(e_variable "X"); (e_ground (@t_term symbol builtin_value "var" []))]); (e_fun b_or [(e_fun b_isZ [(e_variable "V")]); (e_fun b_isString [(e_variable "V")])])]))
; (basic_rule "var.lookup" (@t_term symbol BuiltinOrVar "c" [(@t_term symbol BuiltinOrVar "builtin.cseq" [(t_over (bov_variable "X")); (t_over (bov_variable "REST"))]); (t_over (bov_variable "STATE"))]) (@t_term symbol Expression2 "c" [(@t_term symbol Expression2 "builtin.cseq" [(@t_over symbol Expression2(e_fun b_map_lookup [(e_variable "STATE"); (e_variable "X")])); (@t_over symbol Expression2(e_variable "REST"))]); (@t_over symbol Expression2(e_variable "STATE"))]) (e_fun b_have_same_symbol [(e_variable "X"); (e_ground (@t_term symbol builtin_value "var" []))]))
; (framed_rule frame_simple "stmt.seq" (@t_term symbol BuiltinOrVar "seq" [(@t_term symbol BuiltinOrVar "unitValue" []); (t_over (bov_variable "X"))]) (@t_over symbol Expression2(e_variable "X")) (e_fun b_true []))
; (framed_rule frame_simple "bexpr.eq" (@t_term symbol BuiltinOrVar "eq" [(t_over (bov_variable "X")); (t_over (bov_variable "Y"))]) (@t_over symbol Expression2(e_fun b_eq [(e_variable "X"); (e_variable "Y")])) (e_fun b_and [(e_fun b_isZ [(e_variable "X")]); (e_fun b_isZ [(e_variable "Y")])]))
; (framed_rule frame_simple "bexpr.le" (@t_term symbol BuiltinOrVar "le" [(t_over (bov_variable "X")); (t_over (bov_variable "Y"))]) (@t_over symbol Expression2(e_fun b_Z_isLe [(e_variable "X"); (e_variable "Y")])) (e_fun b_and [(e_fun b_isZ [(e_variable "X")]); (e_fun b_isZ [(e_variable "Y")])]))
; (framed_rule frame_simple "bexpr.lt" (@t_term symbol BuiltinOrVar "lt" [(t_over (bov_variable "X")); (t_over (bov_variable "Y"))]) (@t_over symbol Expression2(e_fun b_Z_isLt [(e_variable "X"); (e_variable "Y")])) (e_fun b_and [(e_fun b_isZ [(e_variable "X")]); (e_fun b_isZ [(e_variable "Y")])]))
; (framed_rule frame_simple "bexpr.neg" (@t_term symbol BuiltinOrVar "not" [(t_over (bov_variable "X"))]) (@t_over symbol Expression2(e_fun b_bool_neg [(e_variable "X")])) (e_fun b_isBool [(e_variable "X")]))
; (framed_rule frame_simple "stmt.ite.true" (@t_term symbol BuiltinOrVar "ite" [(t_over (bov_variable "B")); (t_over (bov_variable "X")); (t_over (bov_variable "Y"))]) (@t_over symbol Expression2(e_variable "X")) (e_fun b_and [(e_fun b_isBool [(e_variable "B")]); (e_fun b_eq [(e_variable "B"); (e_fun b_true [])])]))
; (framed_rule frame_simple "stmt.ite.false" (@t_term symbol BuiltinOrVar "ite" [(t_over (bov_variable "B")); (t_over (bov_variable "X")); (t_over (bov_variable "Y"))]) (@t_over symbol Expression2(e_variable "Y")) (e_fun b_and [(e_fun b_isBool [(e_variable "B")]); (e_fun b_eq [(e_variable "B"); (e_fun b_false [])])]))
; (framed_rule frame_simple "while.unfold" (@t_term symbol BuiltinOrVar "while" [(t_over (bov_variable "B")); (t_over (bov_variable "S"))]) (@t_term symbol Expression2 "ite" [(@t_over symbol Expression2(e_variable "B")); (@t_term symbol Expression2 "seq" [(@t_over symbol Expression2(e_variable "S")); (@t_term symbol Expression2 "while" [(@t_over symbol Expression2(e_variable "B")); (@t_over symbol Expression2(e_variable "S"))])]); (@t_term symbol Expression2 "unitValue" [])]) (e_fun b_true []))
